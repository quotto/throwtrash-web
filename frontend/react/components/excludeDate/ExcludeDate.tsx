...
import { withStyles, Grid, Select, MenuItem, IconButton, Button, WithStyles, Theme } from '@material-ui/core';
...
export default connector(withStyles(styles)(withTranslation()(withRouter(ExcludeDate))));