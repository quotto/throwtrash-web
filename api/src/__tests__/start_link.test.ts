...
describe("start_link",()=>{
    it("正常終了：LoginWithAmazonによるアカウントリンク",async()=>{
        ...
        const loginMatchRe = /^https:\/\/www\.amazon\.com\/ap\/oa\?client_id=dummy_client_id&scope=alexa::skills:account_linking&response_type=code&state=.+&redirect_uri=https:\/\/mobile.mythrowaway.net\/dev\/enable_skill$/;
